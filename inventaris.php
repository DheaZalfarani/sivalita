...
<head>
    ...
    <!-- import bootstrap  -->
    <title>Data Inventaris Vaksin</title>
    ...
    <div id="main" data-bs-aos="fade-in">
        ...
        <div class="container" data-bs-aos="fade-up">
            <div style="text-align: center"><input id="myInput" onkeyup="myFunction()"
                    ...
                    placeholder="Cari data vaksin.."></input></div>
            <br><br>
            ...
            <table id="myTable" style="width:100%;">
                ...
                <tbody>
                    ...
                    $vaksin = mysqli_query($conn, "select * from inventaris ORDER BY waktu");

                    //melooping(perulangan) dengan menggunakan while
                    while ($data = mysqli_fetch_array($vaksin)) {
                        $id = $data['id'];
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Edit Data Vaksin</h5>
                        ...
                        data-data tersebut ditampilkan sama seperti menampilkan data pada tabel. -->
                                    <div>
                                            ...
                                            <form action="function.php" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input name="waktu" type="date" class="form-control"
                                                        placeholder="Tanggal Masuk Vaksin"
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="submit" name="update4" class="btn"
                        ...
                        data-data tersebut ditampilkan sama seperti menampilkan data pada tabel. -->
                                        <div class="modal-body">
                                            Apakah Anda yakin ingin menghapus data vaksin ini?
                                            <input type="hidden" name="id" value="<?= $id; ?>">
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-danger" name="hapus4">Hapus</button>
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="function.php" method="post">
                        <div class="form-group">
                            <label>Tanggal Masuk</label>
                            <input name="waktu" type="date" class="form-control" placeholder="Tanggal Masuk Vaksin"
                                value="" required>
                        </div><br>
                        <div class="form-group">
                            <label>Jenis Vaksin</label>
                            <input name="jenis" type="text" class="form-control" placeholder="Jenis Vaksin" required>
                        </div><br>
                        <div class="form-group">
                            <label>Stok</label>
                            <input name="stok" type="number" class="form-control" placeholder="Stok Vaksin" required>
                        </div><br>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                    <input type="submit" name="submit4" class="btn" style="background-color: #3FBBC0; color: white;"
                        value="Simpan">
                </div>
                </form>
            </div>
