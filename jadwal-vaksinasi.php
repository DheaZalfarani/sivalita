...
<head>
    ...
    <!-- import bootstrap  -->
    <title>Jadwal Vaksinasi Balita</title>
...
<body>
    ...
    <div id="main" data-bs-aos="fade-in">
        ...
        <div class="container" data-bs-aos="fade-up">
            <div style="text-align: center"><input id="myInput" onkeyup="myFunction()"
                    ...
                    placeholder="Cari jadwal vaksinasi.."></input></div>
            <br><br>
            ...
            <table id="myTable" style="width:100%;">
                <thead class=" thead-dark">
                    ...
                    <tr>
                        ...
                        <th style="width:15%">Jenis Vaksin</th>
                ...
                <tbody>
                    ...
                    $jadwal = mysqli_query($conn, "select * from jadwalvaksinasi ORDER BY tanggal, waktu");
                    ...
                    while ($data = mysqli_fetch_array($jadwal)) {
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Edit Jadwal Vaksinasi</h5>
                        ...
                        data-data tersebut ditampilkan sama seperti menampilkan data pada tabel. -->
                                    <div>
                                        <div class="modal-body">
                                            <form action="function.php" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="nama2" type="text" class="form-control"
                                                        placeholder="Nama Petugas Medis"
                                                        value="<?php echo $data['nama2']; ?>">
                                                </div><br>
                                                <div class="form-group">
                                                    <label>Nama Petugas 3</label>
                                                    <input name="nama3" type="text" class="form-control"
                                                        placeholder="Nama Petugas Medis"
                                                        value="<?php echo $data['nama3']; ?>">
                                                </div><br>
                                                <div class="form-group">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="submit" name="update2" class="btn"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form method="post" action="function.php">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Hapus Jadwal Vaskinasi</h5>
                                            <button type="button" class="btn-close" data-dismiss="modal"></button>
                                            </button>
                                        </div>
                                        <!-- di dalam modal-body terdapat 4 form input yang berisi data.
                        data-data tersebut ditampilkan sama seperti menampilkan data pada tabel. -->
                                        <div class="modal-body">
                                            Apakah Anda yakin ingin menghapus jadwal vaksinasi ini?
                                            <input type="hidden" name="id" value="<?= $id; ?>">
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-danger" name="hapus2">Hapus</button>
                                        </div>
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Tambah Jadwal Vaksinasi</h4>
                    <button type="button" class="btn-close" data-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form action="function.php" method="post">
                        ...
                        <div class="form-group">
                            <label>Nama Petugas 2</label>
                            <input name="nama2" type="text" class="form-control" placeholder="Nama Petugas Medis"
                                value="" required>
                        </div><br>
                        <div class="form-group">
                            <label>Nama Petugas 3</label>
                            <input name="nama3" type="text" class="form-control" placeholder="Nama Petugas Medis"
                                value="" required>
                        </div><br>
                        <div class="form-group">
                            <label>Tanggal dan Waktu Mulai</label>
                        ...
                        <div class="form-group">
                            <label>Lokasi</label>
                            <input name="lokasi" type="text" class="form-control" placeholder="Lokasi Vaksinasi"
                                required>
                        </div><br>
                        <div class="form-group">
                            <label>Jenis Vaksin</label>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" name="submit2" class="btn" style="background-color: #3FBBC0; color: white;"
                        value="Simpan">
                </div>
                </form>
            </div>
